...
Route::get('/baseball/game_detail/{date}', [GameDetailController::class, 'index'])->name('baseball.game_detail');
Route::get('/baseball/game_detail/{date}/create', [GameDetailController::class, 'create'])->name('baseball.game_detail.create');
